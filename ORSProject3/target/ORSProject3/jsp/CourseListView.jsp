<%@page import="in.co.rays.proj3.ctl.CourseListCtl"%>
...
<%@page import="java.util.Iterator"%>
	...
	<jsp:useBean id="model" class="in.co.rays.proj3.model.CourseModelHibImpl" scope="request"></jsp:useBean>
	  ...
	  <div class="container-fluid text-center">
           <div class="form-inline" >
				<div class="form-group  text-center">
					...
					<input type="text"  class="form-control" name="courseName" size=15
					placeholder="Enter Role Name" value="<%=ServletUtility.getParameter("courseName", request)%>">
				</div>
